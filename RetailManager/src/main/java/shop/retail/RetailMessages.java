...
/**
 * This class describes the constants for messages used during the application
 * @author Sangram
 *
 */
public class RetailMessages {

	public static final String SUCCESS = "Retail Manager is running!";
	public static final String SHOP_ADDED = "New shop has been added successfully";
	public static final String SHOP_ADD_FAILED = "Exception while adding a new Shop";
